...
export default async function TaskDetailPage({ params }: { params: any }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Hoàn thành Captcha hoặc các bước xác minh nếu được yêu cầu.",
      icon: <ShieldCheck className="w-5 h-5" />,
    },
    {
      title: "Nhận mã / Get Link",
      description:
        "Đợi bộ đếm giây kết thúc và nhấn vào nút 'Lấy link' hoặc 'Tiếp tục'.",
      icon: <ExternalLink className="w-5 h-5" />,
    },
    {
      title: "Hoàn tất & Nhận thưởng",
      description:
        "Sau khi quay lại MMOChill, số tiền sẽ được tự động cộng vào ví của bạn.",
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-indigo-100 max-w-md text-sm leading-relaxed">
              {task.description ||
                "Hoàn thành các bước hướng dẫn bên dưới để nhận ngay phần thưởng vào ví điện tử của bạn."}
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 text-center min-w-[160px]">
            ...
            <p className="text-xs font-medium text-white/50 uppercase mt-1">
              VND
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 flex gap-3 text-amber-500">
            ...
            <p className="text-xs leading-relaxed">
              <strong>Lưu ý:</strong> Vui lòng không đóng trang vượt link quá
              sớm. Hệ thống chống gian lận sẽ tự động kiểm tra thời gian thực
              hiện của bạn. Phát hiện gian lận sẽ bị khóa tài khoản vĩnh viễn.
            </p>
          </div>
        </div>
          ...
          <div className="bg-card border border-border rounded-[2rem] p-8 shadow-sm text-center sticky top-24">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 mb-6 flex items-center justify-between gap-4">
              <div className="text-left overflow-hidden">
                <p className="text-[10px] font-bold text-primary uppercase tracking-widest mb-1 select-none">
                  Link mục tiêu
                </p>
                <p className="text-xs font-medium text-muted-foreground truncate max-w-[180px] blur-[2px] select-none">
                  {task.is_completed
                    ? "Đã hoàn thành"
                    : task.target_url || "Sẽ được cung cấp sau khi claim"}
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-green-500/10 border border-green-500/20 text-green-500">
                  ...
                  <p className="text-[10px] opacity-80">
                    Phần thưởng đã được cộng vào ví của bạn.
                  </p>
                </div>
                <Link
                  href="/tasks"
            ...
            <p className="text-[10px] text-muted-foreground mt-6 leading-relaxed">
              Bằng cách nhấn bắt đầu, bạn đồng ý với các quy định về thực hiện
              nhiệm vụ của MMOChill.
            </p>
          </div>
        </div>
      </div>
